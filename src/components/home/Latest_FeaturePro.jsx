    ...
    >
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center h-full relative">
          ...
          <div className="lg:w-1/2 w-full lg:pl-8 pl-0 lg:mt-0 mt-8">
            <h2 className="text-[35px] font-bold text-[#151875] mb-6">Unique Features Of leatest & Trending Poducts</h2>
            ...
            <div className="flex items-center gap-8">
                <button className="bg-[#FB2E86] text-white px-6 py-2 rounded-md hover:bg-[#e02678] transition cursor-pointer font-semibold">Add To Cart</button>
