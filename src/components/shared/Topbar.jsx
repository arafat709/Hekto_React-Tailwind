...
const Topbar = () => {
  return (
    <>
      <div className="container mx-auto font-font lg:block hidden">
        <div className="bg-[#7E33E0]  flex justify-between items-center text-white font-semibold py-2 px-44 text-[14px]">
